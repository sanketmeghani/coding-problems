...
public class RotatedArrayTest {
    ...
    public void shouldFindPivotForRotatedArrayWithAscendingOrder() {
        ...
        assertEquals("Pivot found for non-rotated array", 4, RotatedArray.findPivot(input));
    }
    ...
    public void shouldFindPivotForRotatedArrayWithDescendingOrder() {
        ...
        assertEquals("Pivot found for non-rotated array", 2, RotatedArray.findPivot(input));
    }
}
